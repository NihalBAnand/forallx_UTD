...
\item \textbf{Camestres} All $C$s are $B$s. No $A$s are $B$s.
	\therefore\  No $A$s are $C$s.
...
\item \textbf{Datisi} All $B$s are $C$s. Some $B$ is $A$.
	\therefore\  Some $A$ is $C$.
\item \textbf{Disamis} Some $A$ is $B$. All $A$s are $C$s.
	\therefore\  Some $B$ is $C$.
\item \textbf{Ferison} No $B$s are $C$s. Some $A$ is $B$.
	\therefore\  Some $A$ is not $C$.
\item \textbf{Ferio} No $B$s are $C$s. Some $B$ is $A$.
	\therefore\  Some $A$ is not $C$.
